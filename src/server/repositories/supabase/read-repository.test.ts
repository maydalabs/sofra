...
import { SupabaseSofraReadRepository } from './read-repository'
...
describe('SupabaseSofraReadRepository', () => {
  it('maps the anonymous allowlist without inventing private fields', async () => {
    const repository = new SupabaseSofraReadRepository(createGateway())
