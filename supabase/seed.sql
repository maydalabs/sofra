...
insert into public.pricing_policies (
  id, name, currency, take_rate_basis_points, minimum_lead_days, maximum_horizon_days,
  booking_cutoff_hours, roster_lock_hours, shared_minimum_travelers,
  maximum_shared_party_size, new_host_active_table_limit, new_host_weekly_dinner_limit, active_from
) values (
  '20000000-0000-4000-8000-000000000001', 'Phase 1 development default', 'TRY', 2500, 7, 35,
  36, 24, 2, 2, 2, 2, now()
) on conflict (id) do nothing;

-- Fictional local users. These are not real people and have no production credentials.
insert into auth.users (
  id, instance_id, aud, role, email, encrypted_password, email_confirmed_at,
  raw_app_meta_data, raw_user_meta_data, created_at, updated_at
) values
  ('10000000-0000-4000-8000-000000000001', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'ayse@demo.sofra.local', '', now(), '{"provider":"email","providers":["email"]}', '{"name":"Ayşe"}', now(), now()),
  ('10000000-0000-4000-8000-000000000002', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'selma@demo.sofra.local', '', now(), '{"provider":"email","providers":["email"]}', '{"name":"Selma"}', now(), now()),
  ('10000000-0000-4000-8000-000000000003', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'figen@demo.sofra.local', '', now(), '{"provider":"email","providers":["email"]}', '{"name":"Figen"}', now(), now()),
  ('10000000-0000-4000-8000-000000000004', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'deniz@demo.sofra.local', '', now(), '{"provider":"email","providers":["email"]}', '{"name":"Deniz"}', now(), now()),
  ('10000000-0000-4000-8000-000000000005', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'kemal@demo.sofra.local', '', now(), '{"provider":"email","providers":["email"]}', '{"name":"Kemal"}', now(), now()),
  ('10000000-0000-4000-8000-000000000006', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'ece@demo.sofra.local', '', now(), '{"provider":"email","providers":["email"]}', '{"name":"Ece"}', now(), now()),
  ('10000000-0000-4000-8000-000000000007', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'selin@demo.sofra.local', '', now(), '{"provider":"email","providers":["email"]}', '{"name":"Selin"}', now(), now()),
  ('10000000-0000-4000-8000-000000000008', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'traveler@demo.sofra.local', '', now(), '{"provider":"email","providers":["email"]}', '{"name":"Demo Traveler"}', now(), now()),
  ('10000000-0000-4000-8000-000000000009', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'operator@demo.sofra.local', '', now(), '{"provider":"email","providers":["email"]}', '{"name":"Demo Operator"}', now(), now())
on conflict (id) do nothing;

insert into public.profiles (id, display_name, preferred_locale) values
  ('10000000-0000-4000-8000-000000000001', 'Ayşe', 'tr'),
  ('10000000-0000-4000-8000-000000000002', 'Selma', 'tr'),
  ('10000000-0000-4000-8000-000000000003', 'Figen', 'tr'),
  ('10000000-0000-4000-8000-000000000004', 'Deniz', 'tr'),
  ('10000000-0000-4000-8000-000000000005', 'Kemal', 'tr'),
  ('10000000-0000-4000-8000-000000000006', 'Ece', 'tr'),
  ('10000000-0000-4000-8000-000000000007', 'Selin', 'tr'),
  ('10000000-0000-4000-8000-000000000008', 'Demo Traveler', 'en'),
  ('10000000-0000-4000-8000-000000000009', 'Demo Operator', 'tr')
on conflict (id) do nothing;
